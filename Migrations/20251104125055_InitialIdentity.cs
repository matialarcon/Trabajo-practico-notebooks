    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    prestamoId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    profesorId = table.Column<int>(type: "INTEGER", nullable: false),
                    fechaSalida = table.Column<string>(type: "TEXT", nullable: false),
                    fechaEntrada = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prestamos", x => x.prestamoId);
                    table.ForeignKey(
                        name: "FK_Prestamos_Profesores_profesorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    prestamoDetalleId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    prestamoId = table.Column<int>(type: "INTEGER", nullable: false),
                    equipoId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_prestamoDetalle_Equipos_equipoId",
                        column: x => x.equipoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_prestamoDetalle_equipoId",
